...
<div class="col-12 d-flex justify-content-start p-0">
    <div>
        <b>Estás viendo:</b>&nbsp;<a class="a" href="{{route('unsubscribe.index')}}">{{$title}}</a>
    </div>
</div>
<br>
@if ($users->isNotEmpty())
<div class="col-12 d-flex justify-content-end p-0">
    <div>
        <a class="a_nav" href="{{route('unsubscribe.init')}}"><b>Iniciar bajas</b></a>
    </div>
</div>
<br>
@endif
...
<div class="row">
    <div class="col-12">
        <p>
            <h4 class="bg-dark" style="color:white">No hay bajas pendientes.</h4>
        </p>
    </div>
</div>
@endif
